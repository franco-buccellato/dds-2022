...
//        repositorioInteresAdopcion.setPublicaciones(Arrays.asList(publicacionInteres1, publicacionInteres2));
//
//        when(repositorioAdopcion.getAdopcionesRecomendadas(publicacionInteres1)).thenReturn(Arrays.asList(publicacion1));
